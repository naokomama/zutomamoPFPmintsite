...
export default function Home() {
  ...
  return (
    <main className="w-screen min-h-screen flex flex-col items-center">
      ...
      <img src={ SUB_DIRECTRY2 + "zutomamologo_pink_03.png" } alt="ずとまもロゴ" style={{ textAlign: 'center', width: '100%', maxWidth: '350px', height: '50px' }} />
      </div>
      <div className='w-full max-w-screen-md px-4' style={{ textAlign: 'center', width: '450px' }}>
      <img src={ SUB_DIRECTRY2 + "PFP-100.jpg" } alt="ずとまもPFP" style={{ textAlign: 'center', width: '100%', maxWidth: '450px', height: '450px' }} />
      </div>
